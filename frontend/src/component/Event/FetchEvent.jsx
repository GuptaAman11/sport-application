...
const FetchEvent = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="events my-8">
        <div className="fixed z-10 left-2">
          <button
            onClick={handleOnClick}
            type="button"
            class="focus:outline-none text-white bg-purple-900 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
          >
            Create Profile
          </button>
        </div>
          ...
          event.map((event, index) => (
            <div key={index} className="event-card">
              ...
              <div className="card-content">
                <label for="">{event.sportname}</label>
                <p className="description">{event.description}</p>
                <div className="trio">
                  <div className="prize">
                    <p className="location">{event.location}</p>
                    <span>Rs {event.prize}/-</span>
                  </div>
