...
const Login1 = () => {
  ...
  return (
    <div class="min-h-screen flex items-center justify-center bg-purple-700 my-6">
        ...
        <div class="w-1/2 p-5">
          ...
          <form action="" onSubmit={handleOnSubmit}>
            ...
            <div class="mb-4">
              <button
                type="submit"
                class="w-full bg-blue-500 text-white rounded-lg px-4 py-2 hover:bg-blue-600 focus:outline-none"
              >
                Submit
              </button>
            </div>
          ...
          <Link to={"/signup"}>
            <p>
              Not a member? <a href="#">Click here for Registration</a>
            </p>
          </Link>
        </div>
      </div>
